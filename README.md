# Commodore Component: rabbitmq-operator

This is a [Commodore][commodore] Component for rabbitmq-operator.

This repository is part of Project Syn.
For documentation on Project Syn and this component, see [syn.tools](https://syn.tools).

The component deploys three Helm charts published to GHCR as OCI artifacts:
...
The component tests additionally compile the `test-helm-chart` values dump chart.
